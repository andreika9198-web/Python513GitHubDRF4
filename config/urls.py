...
schema_view = get_schema_view(
    openapi.Info(
        title="AnimalQuiz API",
        default_version='v 0.1',
        description="API for AnimalQuiz",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="andreika9198@gmail.com"),
...
urlpatterns = [
    ...
    # app urls
    path('', include(('sections.urls', 'sections'), namespace='sections')),
